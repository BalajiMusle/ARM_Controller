...
int eint2::get_switch_released()
{
	return eint2::switch_released;
}

void eint2::set_switch_released(int switch_released)
{
	eint2::switch_released = switch_released;
}
